    ...
    <section class="">
      <div class=" text-azul-ap relative flex items-center ">
        <div class="absolute justify-center w-full pr-8 md:w-5/6  flex flex-col space-y-3 md:justify-end items-end ">
          ...
          <form
            action=""
            class="space-y-1 flex flex-col justify-end items-end w-72"
          >
            ...
            <div>
              <button class="bg-azul-ap flex justify-between space-x-2  w-full -scale-2  px-4 py-2 rounded text-white items-center hover:bg-sol-ap">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        <img
          class="h-300 md:h-400 w-full transform -scale-x-100 -z-10 object-cover  justify-center "
          src={bgFamily}
          alt={"fondoFamilia"}
        />
      </div>
