  ...
  return (
    <header className="p-6 text-md shadow-md">
      <nav className="flex justify-around items-center ">
        ...
        <div
          className={`md:flex  font-bold text-md items-center justify-around ${
            showMenu ? "" : "hidden"
          }`}
        >
          <ul
          ...
          >
            <li>
              <a
                href="#"
                className="text-azul-ap rounded hover:drop-shadow-lg hover:text-sol-ap "
              >
                Inicio
              </a>
            </li>
            ...
            <li>
              <a className="text-azul-ap rounded hover:drop-shadow-lg hover:text-sol-ap ">
                Contactos
              </a>
            </li>
          </ul>
        ...
        <button
          className="bg-azul-ap  flex p-4 h-10 rounded text-white items-center hover:bg-sol-ap "
