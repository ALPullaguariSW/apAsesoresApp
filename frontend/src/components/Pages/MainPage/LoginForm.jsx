...
function LoginForm(props) {
  ...
  return (
    <section className="bg-white p-24 rounded shadow-2xl">
      <button
        id="close"
      ...
      <div className="mb-4">
        <div className="flex justify-start items-center">
          ...
          <label className="block text-azul-ap font-semibold">Usuario</label>
        </div>
        <input
          type="text"
          id="username"
      ...
      <div className="mb-4">
        <div className="flex justify-start items-center">
          ...
          <label className="block text-azul-ap font-semibold">Contraseña</label>
        </div>
